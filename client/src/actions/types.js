...
export const CHECK_PASS_TOKEN_SUCCESS = 'CHECK_PASS_TOKEN_SUCCESS';
export const CHECK_PASS_TOKEN_FAIL = 'CHECK_PASS_TOKEN_FAIL';
export const CHANGE_PASSWORD = 'CHANGE_PASSWORD';
export const CHANGE_PASSWORD_FAIL = 'CHANGE_PASSWORD_FAIL';
export const LOGIN_SOCIAL_MEDIA_SUCCESS = 'LOGIN_SOCIAL_MEDIA_SUCCESS';
export const LOGIN_SOCIAL_MEDIA_FAIL = 'LOGIN_SOCIAL_MEDIA_FAIL';
